...
def parse_args():
    ...
    parser.add_argument('--datatype', type=str, default="cosim", help='dataset type')
    parser.add_argument("--testing", action='store_const', default=False, const=True)
    parser.add_argument('--savename', type=str, default="", help='file name appendix')
